			...
			<div class="col-sm-12 col-md-12 col-lg-5 col-xl-5 ">
				<div class="card">
					...
					<div class="card-body d-flex justify-content-center">
						...
						<h6 class="text-center mb-5">To keep connected with us please login with your personal info.</h6>
						...
						<form method="post" action="LoginController?action=login"
							...
							<div>
								<button type="submit" class="btn btn-primary shadow login-btn fw-semibold w-100" >Login</button>
							</div>
							<br><br>
